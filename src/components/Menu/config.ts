...
const config: MenuEntry[] = [
  ...
  },
  {
    ...
    items: [
      {
        label: 'Exchange',
        href: 'https://pancakeswap.finance/swap#/swap?inputCurrency=0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c',
      },
      {
        label: 'Liquidity',
        href: 'https://exchange.pancakeswap.finance/#/add/0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c/0xe9e7cea3dedca5984780bafc599bd69add087d56',
      },
    ],
  },
  {
  ...
  // },
  {
    ...
    items: [
      ...
      {
        label: 'Overview',
        href: 'https://pancakeswap.info/token/0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c',
      },
      // {
      //   label: 'CoinGecko',
